...
func HandleGetOrder(ctx context.Context, queries *sqlc.Queries) http.Handler {
...
func HandleCreateOrder(ctx context.Context, db *sql.DB, queries *sqlc.Queries) http.Handler {
	return http.HandlerFunc(func(writer http.ResponseWriter, request *http.Request) {
...
func HandleAddItemsToOrder(ctx context.Context, db *sql.DB, queries *sqlc.Queries) http.Handler {
	return http.HandlerFunc(func(writer http.ResponseWriter, request *http.Request) {
		// Читаем тело запроса
		orderId := request.PathValue("order_id")
...
func HandlerListOrders(ctx context.Context, db *sql.DB, queries *sqlc.Queries) http.Handler {
	return http.HandlerFunc(func(writer http.ResponseWriter, request *http.Request) {
